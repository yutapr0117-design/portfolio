...
There are **317** worked entries across this directory (measured 2026-09-09; the list is append-only, so treat it as a floor). This page exists so that you do not have to
...
| **Are you posting to the lists right now?** | **No — paused since 2026-09-09.** The OSI Moderators announced that posts an AI wrote most of will be rejected (`against.md` #119 / register B14; the verbatim notices are in `rounds/`). The single source is `FROZEN.md`'s `POSTING-STATUS` marker and **Check 467 requires the four faces to agree with it, in both directions** |
