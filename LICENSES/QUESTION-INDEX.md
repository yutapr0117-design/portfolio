...
There are **319** worked entries across this directory (measured 2026-09-09; the list is append-only, so treat it as a floor). This page exists so that you do not have to
...
| **Are you posting to the lists right now?** | **Read `FROZEN.md`'s `POSTING-STATUS` marker — it is the single source, and this page deliberately does not copy it** (pages that copied it kept saying "paused" after posting resumed: `against.md` #195 / #222). The dated history: posting stopped on 2026-09-09 after the OSI Moderators announced that posts an AI wrote most of will be rejected (#119 / register B14; the verbatim notices are in `rounds/`), and resumed on 2026-09-17. **The one message the owner sent to `license-discuss` after resuming was rejected by moderation** (#215) |
