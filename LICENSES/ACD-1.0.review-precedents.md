...
**当時これを「記録に在る唯一の日本発の提出」と書いた。⚠ それは誤りだった（2026-09-25 に訂正・`against.md` #241）** ——**2009 年の IPA Font License v1.0 が在り、しかも承認されている**（§1.110）。**誤った原因は探し方にある** —— この節は**差出人のドメインから日本の参加者を数えて**辿り着いており、**提出名の側から数えると別の 1 件が出た。**
...
**§1.105 が「唯一」と書いたのを撤回する根拠でもある**（`against.md` #241）。
