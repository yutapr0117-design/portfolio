...
**同日の補足で、オーナーが条件を狭めた。** 原文: *「もちろん、ディスカッション結果を得られるのが
...
**半月は「議論が来そうにない」の目安であって、提出の引き金ではない。** 提出の条件は 2 つあり、
**どちらも上の表より強い**:

- **自信を持って出せる改善版が在ること。** 表は**欠落の不在**を測るが、こちらは
  **積極的な judgement** を要求する。「欠けは無い」と「出せる」は同じではない。
- **両アーカイブの掘削と自前の調査から、承認を受けられると判断できること。**
