...
**Sixteen items are recorded, and all sixteen are unrepaired in 1.0, deliberately** — **seven of them (E3, E5, E12, E13, E14, E15, E16) are closed in the 1.1 draft**, which is a separate file that is not in force and has not been submitted. ⚠ **Until 2026-09-09 this
