...
| E17 | §5.3 | **同じことをする §5.3 と §12.4 のうち、§12.4 だけが法域の限定を持つ**（covenant が無体物と共に *run* すること、遠い受領者が *intended beneficiary* として依拠できること ——どちらも法域で扱いが違う）| **未着手・設計判断**。限定を付ければ整合するが**下流への保証が弱くなる**。**そのままなら審査者が先に見つける。** 2026-09-14 に外部レビューの角度で発見 |
