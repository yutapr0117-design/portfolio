...
| When AI/ML licensing entered the review record | **2026-09-06** | **Not before 2024; three submissions in 2026** | Of the tracker's 252 records, five have threads that substantively concern machine learning, training data, model weights or text-and-data mining (≥3 term occurrences in the record): one 2024 discussion, ModelGo v2 (2025, pending), and in 2026 OpenMDW 1.1 (pending), FMLL (discussion) and AI-MIT 1.0 (withdrawn). **Zero before 2024. None approved yet.** The term threshold is ours, not the tracker's. **This is the evidential form of Carlo Piana's carve-out** — "unless something new has come around" — and it is why the dedication family's 2020–2026 record is the wrong reference class on its own (`against.md` #87) |
