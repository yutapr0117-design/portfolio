...
| **The CC0 review record (2012)** | **2026-09-06 · objections read at source; outcome not** | The patent objections and Bruce Perens' objection to the abandonment-plus-fallback structure are quoted from license-review 2012-02/03. **The message in which Creative Commons withdrew the submission is not present in 2012-01 to 2012-04 on this list**, so the withdrawal itself is still secondary | Look in `license-discuss` for the same period, or in later 2012 months of license-review |
