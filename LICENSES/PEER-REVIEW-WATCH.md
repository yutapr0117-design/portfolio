...
- **`license-discuss` の過去分** —— 取得したのは 2026-07〜09 の 3 か月のみ（計 29 通）。**`license-review` とは参加者も話題も違うリスト**で、CC0 の撤回など `license-review` に無い議論はこちら側にある可能性がある
