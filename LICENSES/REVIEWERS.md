...
| **Looking for a specific answer** | [`QUESTION-INDEX.md`](QUESTION-INDEX.md) | 158 worked entries, indexed by the question rather than the filename |
| **The case against** | [`ACD-1.0.against.md`](ACD-1.0.against.md) | **Read this first.** All 71 adverse facts, written by us. Two have no answer; one of those is on its own a sufficient reason to decline |
