...
| **Looking for a specific answer** | [`QUESTION-INDEX.md`](QUESTION-INDEX.md) | 268 worked entries, indexed by the question rather than the filename |
| **The case against** | [`ACD-1.0.against.md`](ACD-1.0.against.md) | **The complete record, and the largest document here — six times the length of the licence.** All 172 adverse facts, written by us. Two have no answer; one of those is on its own a sufficient reason to decline |
