---
file: e2e/drawer.spec.js
audience: ai, human (新卒), 監査人, 採用担当, 学術研究者, 第三者全般
last-updated: 2026-07-07
canonical-ref: playwright.config.cjs / .github/workflows/playwright-regression.yml / js/mobile-drawer.js
---
...
モバイルドロワーの e2e。ドロワー open の ARIA / 背景 isolation / Escape close・desktop resize での stuck-state 解除・WCAG modal focus-trap・再 open 時の scroll 位置保持 (scroll-clobber 回帰)・overlay backdrop click close・nav link 遷移と auto-close を検証する。

## Why

モバイル主要ナビの a11y (focus-trap / inert) と scroll-clobber 回帰 (#262/#297) を機能ゲートで守る。
...
### For AI agents
- 役割タグ: `e2e-spec`, `behavior-gate`, `drawer`
