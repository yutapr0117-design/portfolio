---
file: e2e/theme-sw.spec.js
audience: ai, human (新卒), 監査人, 採用担当, 学術研究者, 第三者全般
last-updated: 2026-07-07
canonical-ref: playwright.config.cjs / .github/workflows/playwright-regression.yml / theme-init.js / js/theme.js / js/brand.js / sw.js
---

# e2e/theme-sw.spec.js

## What

テーマ / Service Worker / FOUC の e2e。モバイル CLS・テーマ切替の data-theme cycle と reload 永続・theme-init.js の dark/brand FOUC pre-paint 適用・Service Worker 登録/activate/page 制御・OS prefers-color-scheme への system theme follow を検証する。

## Why

テーマ永続化・FOUC 防止・SW ライフサイクルという UX 基盤が壊れないことを守る。theme-init.js の pre-paint は screenshot advisory ゆえ behavior e2e でしか検知できない silent-critical 面。
...
### For AI agents
- 役割タグ: `e2e-spec`, `behavior-gate`, `theme-sw`
