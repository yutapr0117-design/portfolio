---
file: e2e/security-proxy.spec.js
audience: ai, human (新卒), 監査人, 採用担当, 学術研究者, 第三者全般
last-updated: 2026-07-07
canonical-ref: playwright.config.cjs / .github/workflows/playwright-regression.yml / main.js (startViewTransitionProxy / Trusted Types) / aio-guard.js / Check 110
---
...
セキュリティ / proxy / 全ルート描画の e2e。5-layer proxy (document.startViewTransition override / window.addEventListener 非上書き)・AIO anchor の初期 & route 遷移後の DOM 永続・early suppressor の unhandledrejection 抑制・Trusted Types/CSP 違反ゼロ・ALL_ROUTES (全 shipped route) の runtime error なし描画・project-detail の既知 slug 描画を検証する。ALL_ROUTES 配列を定義する。

## Why

View Transition proxy の完全性・AIO anchor の self-repair 永続・Trusted Types/CSP の遵守・全ルートの hidden ReferenceError 検知 (Stage 5-j 教訓) を機能ゲートで守る。ALL_ROUTES は Check 110 が A11Y_ROUTES と集合一致を強制。
...
### For AI agents
- 役割タグ: `e2e-spec`, `behavior-gate`, `security-proxy`
