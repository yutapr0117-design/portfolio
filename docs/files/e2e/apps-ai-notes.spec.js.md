...
# e2e/apps-ai-notes.spec.js

## What

AI assist / Markdown notes アプリの e2e。AI assist の応答生成と描画・keyword による troubleshoot/design/general 振り分け・deterministic clock でのローディング解決・Markdown notes の innerHTML-free live preview と永続・toast auto-dismiss・assertive/polite aria-live 通知・AI 入力の IME guard を検証する。
...
### For AI agents
- 役割タグ: `e2e-spec`, `behavior-gate`, `apps-ai-notes`
