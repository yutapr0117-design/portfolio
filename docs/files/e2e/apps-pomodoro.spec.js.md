---
file: e2e/apps-pomodoro.spec.js
audience: ai, human (新卒), 監査人, 採用担当, 学術研究者, 第三者全般
last-updated: 2026-07-07
canonical-ref: playwright.config.cjs / .github/workflows/playwright-regression.yml / js/pomodoro-page.js
---

# e2e/apps-pomodoro.spec.js

## What

Pomodoro アプリの e2e。mode 切替での reset と表示更新・long-break duration・start のカウントダウンと pause 停止・reset の full duration 復元・reload mid-run 後の再開 (frozen-timer guard)・ゼロ完了時の done toast と reset・稼働中の focus-duration 設定変更反映を deterministic clock で検証する。

## Why

stale-closure による永遠に完了しないタイマー (#121/#134) の回帰を deterministic clock 付き e2e で機能ゲート化する。
...
### For AI agents
- 役割タグ: `e2e-spec`, `behavior-gate`, `apps-pomodoro`
