---
file: LICENSES/rounds/2009-04-license-review-mxm-public-license-observed-3of4.txt
audience: ai, human (新卒), 監査人, 第三者全般
last-updated: 2026-09-25
canonical-ref: LICENSES/rounds/README.md (置き方の規約) / LICENSES/ACD-1.0.against.md #243
---

# LICENSES/rounds/2009-04-license-review-mxm-public-license-observed-3of4.txt

## What

**MXM Public License の承認審査**（`license-review` / `license-discuss`・2009 年 4 月・全 59 通）の
**3/4 部**。**我々宛ではなく、ACD-1.0 についてでもない —— 観測である。**
...
起草者からの最も強い反対である**（#243）。**同じ 1 文が人格権にも及んでおり、§12 に当たる**（#244）。
