...
|---|---:|---:|---|---|
| `main.js` | 6,089 | 6,400 | `strong-advisory` | Stage 4: UI コンポーネント（h/createIcon/Toast/BGM）を js/ui-components.js へ抽出し −271 行。次の縮小は service rails（baseline 後） |
