...
|---|---:|---:|---|---|
| `main.js` | 3,045 | 6,400 | `strong-advisory` | Stage 5-m: UI page components 11 関数 (Sidebar/HomePage/ProjectsPage/ProjectDetailPage/AppsPage/AboutPage/ResumePage/ContactPage/FatalPage/AIKnowhowPage/ContactCTA) を js/components.js へ factory pattern で抽出し −1,271 行。累計 7,785→3,045 行（**−61%**）。次の縮小は Apps Component (Task/Todo/Pomodoro/AI/Settings) と Quiz レンダラ |
