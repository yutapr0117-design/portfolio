...
|---|---:|---:|---|---|
| `main.js` | 5,206 | 6,400 | `strong-advisory` | Stage 5-e: AUTHOR identity を js/identity.js へ抽出し −1 行。累計 7,785→5,206 行（−33%）。次の縮小は Store / State / RouteState 等の service rails |
