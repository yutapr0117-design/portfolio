...
|---|---:|---:|---|---|
| `main.js` | 5,207 | 6,400 | `strong-advisory` | Stage 5-d: CONSTANTS（実行時定数）を js/constants.js へ抽出し −46 行。累計 7,785→5,207 行（−33%）。次の縮小は Store / State / RouteState 等の service rails |
