...
| `.github/scripts/checks_license_references.py` | 206 | 400 | `advisory` | **ドシエが書いた矢印が、指した先に在るか**だけを持つ split module（Check 471・5 形）。台帳が「機械強制済」と宣言していた種類を壊して測ったら 7 形のうち 5 形が無防備だった、というのが出自。2026-09-15 に dossier module が advisory を越えたので切り出した |
