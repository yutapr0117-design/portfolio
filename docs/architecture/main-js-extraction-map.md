...
Status        : **Stage 5 物理分割 最終完遂**。Stage 2/3/3-b/4/5/5-b/5-c〜5-s の全 sub-phase を完了し、
                ...
                factory orphan を機械強制。main.js に残る行（Stage 5 完遂時点で 1,086 行・現在値は file-size-budget.md §2 が権威）は AIDK Kernel
