...
Subject       : .github/scripts/check_repository_consistency.py（≈4,016 行・Check 1〜106）の構造地図
...
| 級 | チェック数 | 該当 |
|---|---:|---|
| BLOCKING（失敗で exit 1） | 102 | Check 52/60 を除く全カテゴリのチェック（Check 53〜59, 61〜106 を含む。サブチェックを持つものは全サブが BLOCKING） |
