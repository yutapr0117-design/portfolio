...
Track         : v80+ staged major update (Phase 2 — 「Full coherence audit」 で Check 86〜90 + LICENSE/CONTRIBUTING/CODEOWNERS/CHANGELOG/.claude/CLAUDE.md 新設 + aio-manifest entity 9 field 拡張)
Subject       : .github/scripts/check_repository_consistency.py（≈3,360 行・Check 1〜90）の構造地図
...
| 級 | チェック数 | 該当 |
|---|---:|---|
| BLOCKING（失敗で exit 1） | 86 | Check 52/60 を除く全カテゴリのチェック（Check 53〜59, 61〜90 を含む。サブチェックを持つものは全サブが BLOCKING） |
