...
> **【訂正 2026-09-25・`against.md` #225】上の結論は半分が誤りだった。原文は履歴として残す。**
>
> **正しかった半分**: Agent Skills は実在する標準である。
> **誤っていた半分**: 「**URL も仕様どおりだった**」——これは一度も確かめていない。
> 2026-09-25 に測ると `schemas.agentskills.io` は**親ゾーンの権威 NS 自身が NXDOMAIN + SOA を返し**、
> Wayback に記録は 0 件、**仕様サイト全 9 ページにも公式 repo にもこの host は 1 件も無い**
> （対照つき実測）。**仕様は discovery index も `.well-known` も `$schema` も定義していない。**
>
> **ここが本題である。** 「道具の拒否は道具についての証拠であって世界についての証拠ではない」は
> 正しく、この日それを正しく適用した。**しかし逆もまた真であることを確かめなかった** ——
> **道具の拒否は「世界が健全である」証拠でもない。** 標準が実在することだけを確かめ、
> *だから URL も正しい* と推論して、確かめずに「仕様どおり」と書いた。
> **誤報を止める規律が、逆向きの誤った安心を生んだ。**
> 一般形: **道具を疑ったあとに残るのは「未確定」であって「健全」ではない。**
