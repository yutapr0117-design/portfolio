        ...
        // v80+ Stage 5: ページコンポーネント（deps-none）を葉モジュールへ抽出。
        //   HiringRiskPage / RoleSplitPage / NotFoundPage + 補助関数。
...
具体的なご質問をお聞かせください。`;
        ...
        // ===== Page Components (補助含む) =====
        //   ▼ v80+ Stage 5: HiringRiskPage / RoleSplitPage / NotFoundPage と補助関数を
        //     js/pages.js へ抽出し、ファイル冒頭で import 済み（挙動不変）。
