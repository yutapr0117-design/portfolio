/**
 * js/components.js — UI page components (Sidebar / ProjectsPage /
 ...
 *   const { Sidebar, ProjectsPage, ProjectDetailPage, AppsPage, AboutPage,
...
export function createComponents({ h, createIcon, Toast, BGM, AUTHOR, Router, State, Theme, Brand, Store, tokenize, CONSTANTS, clear, closeDrawer }) {
    ...
    return { Sidebar, ProjectsPage, ProjectDetailPage, AppsPage,
